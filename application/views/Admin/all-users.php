...
<body>
    ...
    ?>
            ...
            <section id="user-table">
                <h2 style="color: #000; text-align: center; margin-bottom: 30px;"><u>All Users</u> </h2>
                            ...
                            <tr>
                                ...
                                <td><?php
                                    ...
                                    if ($status == '1') {
                                        ...
                                        echo " Verified <span class='dot-green'></span>  ";
                                    } else {
                                        echo "Unverified &nbsp <span class='dot-red'></span> ";
                                    }
                                    ?></td>
                            </tr>
                        <?php
