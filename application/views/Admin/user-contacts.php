            ...
            <section id="user-table">
                ...
                <table class="table table-striped" id="mytable">
                    ...
                    <tbody>
                        <?php
                        $i = 0;
                        foreach ($contacts as $usercon) {
                            $i++;
                        ?>
                            <tr>
                                <th scope="row"><?php echo $i ?></th>
                                <td><?php echo $this->encrypt->decode($usercon->email) ?></td>
                                <td><?php echo $this->encrypt->decode($usercon->message) ?></td>
                                <td><a href="<?php echo base_url('Admin/Users/DeleteContact/') . $usercon->con_id ?>"><i class="delete-user fa fa-trash-o" style="font-size: 20px; color:red;"></i></a></td>
            ...
            <div class="row">
                <div class="card text-center col-lg  shadow-lg p-4 mb-5 bg-white rounded">
                    <div class="card-header">
                        <h5 class="card-title">No User Contacts Found</h5>
                    </div>
