...
<body>
    ...
    <section id="notes">
        <h1 class="notes-heading">Account Deletion</h1>
        <div class="row">
            ...
            <div class="col-lg-12" style="text-align: center;">
                <div class="card">
                    <div class="card-body">
                        ...
                        echo $data['email'];
                        ?></b> Email To Delete Your Account. </p>
                        <p class="card-text">We have sent account deletion link to your email</p>
                        <p class="card-text"> Thank You..</p>
                        <button type="button" class="btn btn-dark btn-lg"><a href="<?php echo base_url('Home');?>" style="color: #fff;"><i class="fa fa-home"></i> Go to home</a></button>
