...
<body>
    ...
    <section id="login">
        <form action="<?php echo base_url('Notes/addNotesProcess') ?>" method="post">
            <div class="form-group">

                <label for="exampleInputEmail1">Notes Title</label>
                <input name="note_title" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write Your Notes Title here...">

            </div>
            <div class="form-group">
                <label for="exampleFormControlTextarea1">Notes</label>
                <textarea name="note_body" placeholder="Write Your Notes here..." class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
            </div>
